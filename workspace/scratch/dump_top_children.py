...
def main():
    ...
    print("==========================================")
    print("  VANILLA TOP-LEVEL CHILDREN")
    print("==========================================")
    print(f"Vanilla Root: 0x{van_root['type_id']:X}, children count={len(van_root['children'])}")
    for idx, child in enumerate(van_root['children']):
    ...
    print("\n==========================================")
    print("  FRONTIERS TOP-LEVEL CHILDREN")
    print("==========================================")
    print(f"Frontiers Root: 0x{fro_root['type_id']:X}, children count={len(fro_root['children'])}")
    for idx, child in enumerate(fro_root['children']):
        print(f"Child {idx}: Type 0x{child['type_id']:05X}, size={child['data_size']:,}, children={child['child_count']}")
